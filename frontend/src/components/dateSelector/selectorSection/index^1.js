...
export default function SelectorSection({
  ...
  // three onclick functions to be used to determine the menu that should be
  // open when the modal appears. my idea is that i set an id on the three
  // sections and use that to have the onClick determine which menu to load in
  // the modal. 
