...
export default function SpotListItem({spot}){
  const history =useHistory()
   ...
   return (
    ...
    <div onClick={handleTileClick} style={{display: "flex", flexDirection: "column", backgroundColor: "white", boxSizing: "borderBox", width: "24%", height: "auto",minHeight:"380px", borderRadius: 20, alignItems: "center", margin: "0 2px",cursor:"pointer"}}>
